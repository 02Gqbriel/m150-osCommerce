...
// products price
        $product_query = tep_db_query("select products_id, products_price, products_tax_class_id, products_weight, products_height, products_width, products_depth from " . TABLE_PRODUCTS . " where products_id = '" . (int)$products_id . "'");
